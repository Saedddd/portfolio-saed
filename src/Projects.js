...
const projects = [
    ...
    stars: null,
    forks: null,
    short: 'Я полностью переписал(а) и перезапустил(а) сайт сети спортивных залов, добавив анимации и интерактив.',
    description: (
      <>
        <Typography variant="body2" color="textSecondary" component="p">
          Я переписал(а) фронтенд в FSD-архитектуре, добавил(а) анимации, галереи и динамичные блоки, подключил(а) бэкенд на FastAPI
          и оптимизировал(а) загрузку и адаптивность. Сайт стал масштабируемым и визуально современным.
        </Typography>
      </>
    ),
  ...
  },
  {
    ...
    stars: null,
    forks: null,
    short: 'Я делал(а) фронтенд интернет-магазина: от каталога до корзины и оплаты.',
    description: (
      <>
        <Typography variant="body2" color="textSecondary" component="p">
          Я реализовал(а) фронтенд на Next.js с FSD-архитектурой, интегрировал(а) API с Laravel, подключил(а) приём онлайн-оплаты
          через ЮKassa, настроил(а) корзину, фильтры, поиск и блоки «Рекомендовано» и «Похожие товары». Сайт адаптивен и готов к росту.
        </Typography>
      </>
    ),
...

  {
    ...
    stars: null,
    forks: null,
    short: 'Я разработал(а) удобную и безопасную платформу для автоматизации оформления лизинга и управления клиентами.',
    description: (
      <>
        <Typography variant="body2" color="textSecondary" component="p">
          Я спроектировал(а) сложную форму заявки с поддержкой физ. лиц, ИП и ТОО, реализовал(а) пошаговое
          заполнение анкеты с сохранением состояния и гибкую валидацию данных. Интегрировал(а) управление
...

  {
    ...
    stars: null,
    forks: null,
    short: 'Я участвовал(а) в создании инклюзивной платформы для подбора тьюторов и сопровождения людей с особыми потребностями.',
    description: (
      <>
        <Typography variant="body2" color="textSecondary" component="p">
          Я реализовал(а) фронтенд на Next.js с FSD-архитектурой и участвовал(а) в создании бэкенд-инфраструктуры на Node.js.
          Настроил(а) REST API для регистрации, поиска, бронирования и личных кабинетов, подключил(а) MUI и сделал интерфейс
...

  {
    ...
    stars: null,
    forks: null,
    short: 'Я разработал(а) сложный интерактивный интерфейс с таблицами, расчётами и графиками — браузерный аналог Excel.',
    description: (
      <>
        <Typography variant="body2" color="textSecondary" component="p">
          Я реализовал(а) динамические таблицы с разворачиванием и агрегацией, drag-and-drop для показателей,
